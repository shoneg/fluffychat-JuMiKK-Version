...
This repository is a personal fork of FluffyChat for JuMiKK-specific customization (branding, defaults, and release workflow).

- `main`: upstream-like baseline
- `custom/main`: current customized state of this fork
